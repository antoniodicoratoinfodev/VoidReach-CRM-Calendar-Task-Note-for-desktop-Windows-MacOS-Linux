...
public class Contact {
    ...
    public Contact(String name, String company, String title, String email, String phone, String lastInteraction, String tags) {
        this(name, company, title, email, phone, lastInteraction, tags, "");
    }
